...
def login():
	email_el = driver.find_element(By.XPATH, '//*[@id="username"]')
...
def coinTypeLookup(index):
	match cryp_trades.iloc[index]['asset']:
		case 'BTC':
			return driver.find_element(By.XPATH, f'//*[@id="__vctrans_descr_of_property_{index+1}"]/option[2]')
		case 'ETH':
			return driver.find_element(By.XPATH, f'//*[@id="__vctrans_descr_of_property_{index+1}"]/option[3]')
		case 'LTC':
			return driver.find_element(By.XPATH, f'//*[@id="__vctrans_descr_of_property_{index+1}"]/option[4]')
		case 'BCH':
			return driver.find_element(By.XPATH, f'//*[@id="__vctrans_descr_of_property_{index+1}"]/option[5]')
		case 'XRP':
			return driver.find_element(By.XPATH, f'//*[@id="__vctrans_descr_of_property_{index+1}"]/option[6]')
		case 'DOGE':
			return driver.find_element(By.XPATH, f'//*[@id="__vctrans_descr_of_property_{index+1}"]/option[7]')
		case 'XLM':
			return driver.find_element(By.XPATH, f'//*[@id="__vctrans_descr_of_property_{index+1}"]/option[8]')
		case 'ADA':
			return driver.find_element(By.XPATH, f'//*[@id="__vctrans_descr_of_property_{index+1}"]/option[9]')
		case 'DOT':
			return driver.find_element(By.XPATH, f'//*[@id="__vctrans_descr_of_property_{index+1}"]/option[10]')
		case 'SOL':
			return driver.find_element(By.XPATH, f'//*[@id="__vctrans_descr_of_property_{index+1}"]/option[11]')
		case _:
			return driver.find_element(By.XPATH, f'//*[@id="__vctrans_descr_of_property_{index+1}"]/option[12]')


def setupCryptoTrade(index):
	global crypto_short_term_el
	crypto_short_term_el = driver.find_element(By.XPATH, f'//*[@id="__vctrans_type_of_transaction_{index+1}"]/option[2]')
	global crypto_long_term_el
	crypto_long_term_el = driver.find_element(By.XPATH, f'//*[@id="__vctrans_type_of_transaction_{index+1}"]/option[3]')
	global crypto_long_term_noncovered_el
	crypto_long_term_noncovered_el = driver.find_element(By.XPATH, f'//*[@id="__vctrans_long_tax_lots_{index+1}"]/option[4]')
	global crypto_short_term_noncovered_el
	crypto_short_term_noncovered_el = driver.find_element(By.XPATH, f'//*[@id="__vctrans_short_tax_lots_{index+1}"]/option[4]')
	global crypto_currency_el
	crypto_currency_el = coinTypeLookup(index)
	global crypto_sell_date_el
	crypto_sell_date_el = driver.find_element(By.XPATH, f'//*[@id="__vctrans_date_sold_{index+1}"]')
	global crypto_quantity_el
	crypto_quantity_el = driver.find_element(By.XPATH, f'//*[@id="__vctrans_quantity_{index+1}"]')
	global crypto_proceeds_el
	crypto_proceeds_el = driver.find_element(By.XPATH, f'//*[@id="__vctrans_proceeds_{index+1}"]')
	global crypto_acquisition_date_el
	crypto_acquisition_date_el = driver.find_element(By.XPATH, f'//*[@id="__vctrans_date_acquired_{index+1}"]')
	global crypto_cost_basis_el
	crypto_cost_basis_el = driver.find_element(By.XPATH, f'//*[@id="__vctrans_cost_{index+1}"]')
	global crypto_state_el
	crypto_state_el = driver.find_element(By.XPATH, f'//*[@id="__vctrans_state_{index+1}"]/option[6]')
	global crypto_not_eic_el
	crypto_not_eic_el = driver.find_element(By.XPATH, f'//*[@id="__vctrans_nec_income_{index+1}"]/option[3]')
...
def loopCrypto(start, end):
	while start <= end:
		executeCrypto(start)
		if start != end:
			crypto_add_transaction_el.click()
		start+=1
		time.sleep(2)
...
def fast_forward(times):
	#fast forward x amount of pages in the 1099 form to not have to click for a million years
	for t in range(times):
		skip_bt = driver.find_element(By.XPATH, '//*[@id="footer"]/div[1]/div[3]/a') 
		skip_bt.click()
		time.sleep(1.5)
